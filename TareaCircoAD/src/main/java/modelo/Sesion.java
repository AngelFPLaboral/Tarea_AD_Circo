...
public class Sesion {
	...
	/**
	 * Constructor Default
	 * Usada para sesion vacia y secion invitado
	 */
	public Sesion() {
		this.persona = null;
	...
	//GETTERS
	//Para devolver estos datos si son necesarios visualizarlos, nadie puede dar datos asi que omito los setters
	 ...
	 * Limpia Sesion restableciendo todos sus valores de dentro (== null), menos el invitado que esa sobreentiendo que siempre estara activa
	 */
