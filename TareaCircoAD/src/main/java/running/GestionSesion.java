...
public class GestionSesion {
	...
	//!!! GUARDAR EN OTRO LUGAR PARA QUE NO ESTEN CODIGO FUENTE
	private static final String usuarioAdmin= "admin";
	private static final String contraseñaAdmin="admin";
	...
	//METODOS
	/**
	 * Metodo: 'hijo' de comprobarActividad, devuelve el estado de la sesion sin que haga falta crear o usar la clase SESION, emplea su defaultdel constructor
	 * @return
	 */
	...
	public boolean login(String nombre, String contraseña) {
		...
		if(nombre.equals(usuarioAdmin) && contraseña.equals(contraseñaAdmin)) {
		...
		for(String[] credencial: credenciales) {
			...
			if(nombreUsuario.toLowerCase().equals(nombre.toLowerCase()) && contraseñaUsuario.toLowerCase().equals(contraseña)) {
	...
	public void logout() {
        if (sesion.comprobadorActiva()) {
            ...
            //El caso del else no creo que salte al estar controlado por los menus, pero por si acaso
        } else {
