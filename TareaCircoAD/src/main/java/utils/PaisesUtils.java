...
public class PaisesUtils {
	...
	public static void mostrarPaises() {
		...
		System.out.println("___PAISES DISPONIBLES___");
	...
	/**
	 * Metodo: para extaer la informacion de los nodos sacados del XML
	 * 
	 * @param etiqueta
	 * @param elemento
	 * @return
	...
	/**
	 * Metodo: que confirma si el pais existe en la lista paises extraida del XML
	 * 
	 * @param idPais
	 * @return
	 */
	...
	/**
	 * Metodo: obtiene el nombre del pais correspondiente a un id
	 * @param idPais
	 * @return
	 */
