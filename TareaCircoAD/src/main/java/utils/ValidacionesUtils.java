...
public class ValidacionesUtils {
	...
	/**
	 * Metodo: Valida si sigue las normas que se deben seguir al registrar el nombre
	 * de un usuario nuevo
	 * 
	 * @param nombreUsuario
	 * @return
	...
	/**
	 * Metodo: Valida si sigue las normas que se deben seguir al registrar la
	 * contraseña de un usuario nuevo
	 * 
	 * @param contraseña
	 * @return
	 */
	...
	/**
	 * Metodo: Valida si sigue las normas que se deben seguir al registrar el email
	 * de un usuario nuevo
	 * 
	 * @param email
	 * @return
	...
	public static boolean validarPeriodoFechas(LocalDate fechaInicio, LocalDate fechaFin) {
		...
		// Verificar que la fechas no puedan ser anteriores a la actual
		if (fechaInicio.isBefore(hoy) || fechaFin.isBefore(hoy)) {
			System.out.println("Las fechas no pueden ser anteriores a la fecha actual (" + hoy + ")");
			return false;
		}
		...
		if (diasDiferencia > 365) {
			...
			System.out.println("Duracion actual: " + diasDiferencia);
			return false;
		}
